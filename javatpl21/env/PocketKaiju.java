...
public class PocketKaiju {
  ...
  public boolean startPhase() {
    ...
    if (this.drawnNum >= 15) {
      System.out.println("Deckがなくなりました");
      this.drawnNum = 0;
      // Deckの初期化
    ...
    System.out.println("Playerのポケット怪獣カードDraw----------(Hit Enter!)");
    sc.nextLine();
    // playerCards[0]~[4]に0~14の数字から5つの異なる数字をランダムに選ぶ．このとき，
    ...
    System.out.println("CPUのポケット怪獣カードDraw----------(Hit Enter!)");
    sc.nextLine();
  ...
  // ポケット怪獣ごとにattack,agility,defenceのポイントが定められているので，そのポイントごとにAttackカード，Agilityカード，DefenceカードをDeckに格納する
  public void createDeck() {
    ...
    System.out.println("Playerのポケット怪獣召喚！");
    ...
    System.out.println("CPUのポケット怪獣召喚！");
    System.out.println(this.dn[dino1]);
    System.out.println(this.dn[dino2]);
    System.out.println(this.dn[dino3]);
